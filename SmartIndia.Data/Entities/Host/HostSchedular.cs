...
namespace SmartIndia.Data.Entities.Host
{
    public class HostSchedular
    {
        ...
        //public List<HostSchedularDetails> hostSchedularDetails { get; set; }
    }
    public class UpdateHostSchedular
    {
        [Key]
        public Int64 SchedularId { get; set; }
        public string ACTIONCODE { get; set; }
    ...
    public class BindHostSchedular
    {
        [Key]
        public string ACTIONCODE { get; set; }
        public Int64 UserId { get; set; }
    ...
    public class GetSchedularDetails
    {
        [Key]
        public string ACTIONCODE { get; set; }
        public Int64 SchedularId { get; set; }
